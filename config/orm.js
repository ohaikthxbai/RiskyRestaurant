...
//Select specific restaurant
 ...
 selectComment: function(table, vals, cb) {
    var queryString = "SELECT" +table+ " COMMENT";
    connection.query(queryString, vals, function(err, result) {
        if (err) {
            throw err;
          }
